...
namespace Baku.LibqiDotNet.Utils
{
    ...
    /// <summary><see cref="ReadOnlyDictionary{TKey, TValue}"/>の拡張メソッドを提供します。</summary>
    public static class ReadOnlyDictionaryExtensions
    {
        ...
        /// <returns></returns>
        public static ReadOnlyDictionary<TKey, TValue> ToReadOnlyDictionary<TKey, TValue>(this IDictionary<TKey, TValue> src)
        {
