...
namespace Baku.LibqiDotNet.Service
{
    ...
    public class ALPythonBridge
    {
        ...
        public ALPythonBridge(QiSession session)
        {
        ...
        {
            return (string)SourceService["eval"].Call(arg0_stringToEvaluate);
        }

        /// <summary>eval script and return result. evalReturn(2+2) will return 4</summary>
		/// <param name="arg0_stringToEvaluate">string to eval</param>
		/// <returns>the result of the evaluation</returns>
        public QiValue EvalReturn(string arg0_stringToEvaluate)
        {
            return SourceService["evalReturn"].Call(arg0_stringToEvaluate);
        }
        ...
        public QiValue EvalFull(string arg0_stringToEvaluate)
        {
            return SourceService["evalFull"].Call(arg0_stringToEvaluate);
        }
