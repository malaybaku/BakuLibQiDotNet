...
namespace Baku.LibqiDotNet.Service
{
    ...
    public class ALNotificationManager
    {
        ...
        public ALNotificationManager(QiSession session)
        {
        ...
        public int Add(QiAnyValue arg0_notification)
        {
            return (int)SourceService["add"].Call(arg0_notification);
        }
        ...
        public QiValue Notifications()
        {
            return SourceService["notifications"].Call();
        }
        ...
        public QiValue Notification(int arg0_notificationId)
        {
            return SourceService["notification"].Call(arg0_notificationId);
        }

        /// <summary></summary>
		/// <returns>An array of pending notification.</returns>
        public QiValue _internalNotifications()
        {
            return SourceService["_internalNotifications"].Call();
        }

        /// <summary></summary>
		/// <param name="arg0_notificationId">Notification ID.</param>
		/// <returns>ALValue containing a Notification.</returns>
        public QiValue _internalNotification(int arg0_notificationId)
        {
            return SourceService["_internalNotification"].Call(arg0_notificationId);
        }
        ...
        {
            return (int)SourceService["_severity"].Call();
        }
        ...
        {
            return (bool)SourceService["_isImmediate"].Call(arg0_notificationId);
        }
