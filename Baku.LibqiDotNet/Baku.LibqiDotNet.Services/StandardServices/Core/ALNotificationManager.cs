...
namespace Baku.LibqiDotNet.Service
{
	...
	{
		internal ALNotificationManager(IQiSession session)
		{
			Session = session;
		}
		...
		public static ALNotificationManager CreateService(IQiSession session)
		{
			var result = new ALNotificationManager(session);
		...
		///</summary>
        /// <param name="session">サービスの取得元となるセッション</param>
		public static ALNotificationManager CreateUninitializedService(IQiSession session)
		{
			return new ALNotificationManager(session);
		}
		...
		public void InitializeService()
		{
			if (!IsInitialized)
			{
			    SourceService = Session.GetService("ALNotificationManager");
			}
		}
        ...
        public int Add(object arg0_notification)
        {
            return SourceService["add"].Call<int>(arg0_notification);
        }

        /// <summary>Add a notification.</summary>
		/// <param name="arg0_notification">Contain information for the notification</param>
		/// <returns>Notification ID.</returns>
        public IQiFuture<int> AddAsync(object arg0_notification)
        {
            return SourceService["add"].CallAsync<int>(arg0_notification);
        }

        /// <summary>Remove a notification.</summary>
		/// <param name="arg0_notificationId">Notification ID to remove.</param>
		/// <returns></returns>
        public void Remove(int arg0_notificationId)
        {
            SourceService["remove"].Call(arg0_notificationId);
        }

        /// <summary>Remove a notification.</summary>
		/// <param name="arg0_notificationId">Notification ID to remove.</param>
		/// <returns></returns>
        public IQiFuture RemoveAsync(int arg0_notificationId)
        {
            return SourceService["remove"].CallAsync(arg0_notificationId);
        }

        /// <summary>Get the all array of pending notifications.</summary>
		/// <returns>An array of pending notification.</returns>
        public IQiResult Notifications()
        {
            return SourceService["notifications"].Call<IQiResult>();
        }

        /// <summary>Get the all array of pending notifications.</summary>
		/// <returns>An array of pending notification.</returns>
        public IQiFuture<IQiResult> NotificationsAsync()
        {
            return SourceService["notifications"].CallAsync<IQiResult>();
        }
        ...
        public IQiResult Notification(int arg0_notificationId)
        {
            return SourceService["notification"].Call<IQiResult>(arg0_notificationId);
        }

        /// <summary>Get one notification.</summary>
		/// <param name="arg0_notificationId">Notification ID.</param>
		/// <returns>ALValue containing a Notification.</returns>
        public IQiFuture<IQiResult> NotificationAsync(int arg0_notificationId)
        {
            return SourceService["notification"].CallAsync<IQiResult>(arg0_notificationId);
        }

        /// <summary></summary>
		/// <returns>An array of pending notification.</returns>
        public IQiResult _internalNotifications()
        {
            return SourceService["_internalNotifications"].Call<IQiResult>();
        }

        /// <summary></summary>
		/// <returns>An array of pending notification.</returns>
        public IQiFuture<IQiResult> _internalNotificationsAsync()
        {
            return SourceService["_internalNotifications"].CallAsync<IQiResult>();
        }

        /// <summary></summary>
		/// <param name="arg0_notificationId">Notification ID.</param>
		/// <returns>ALValue containing a Notification.</returns>
        public IQiResult _internalNotification(int arg0_notificationId)
        {
            return SourceService["_internalNotification"].Call<IQiResult>(arg0_notificationId);
        }

        /// <summary></summary>
		/// <param name="arg0_notificationId">Notification ID.</param>
		/// <returns>ALValue containing a Notification.</returns>
        public IQiFuture<IQiResult> _internalNotificationAsync(int arg0_notificationId)
        {
            return SourceService["_internalNotification"].CallAsync<IQiResult>(arg0_notificationId);
        }
        ...
        {
            return SourceService["_severity"].Call<int>();
        }

        /// <summary></summary>
		/// <returns>Maximal Notification severity.</returns>
        public IQiFuture<int> _severityAsync()
        {
            return SourceService["_severity"].CallAsync<int>();
        }

        /// <summary></summary>
		/// <param name="arg0_int">Notification ID.</param>
		/// <returns></returns>
        public void _read(int arg0_int)
        {
            SourceService["_read"].Call(arg0_int);
        }

        /// <summary></summary>
		/// <param name="arg0_int">Notification ID.</param>
		/// <returns></returns>
        public IQiFuture _readAsync(int arg0_int)
        {
            return SourceService["_read"].CallAsync(arg0_int);
        }

        /// <summary></summary>
		/// <param name="arg0_notificationId">Notification ID.</param>
		/// <returns>True if the notification is immediate, false otherwise.</returns>
        public bool _isImmediate(int arg0_notificationId)
        {
            return SourceService["_isImmediate"].Call<bool>(arg0_notificationId);
        }

        /// <summary></summary>
		/// <param name="arg0_notificationId">Notification ID.</param>
		/// <returns>True if the notification is immediate, false otherwise.</returns>
        public IQiFuture<bool> _isImmediateAsync(int arg0_notificationId)
        {
            return SourceService["_isImmediate"].CallAsync<bool>(arg0_notificationId);
        }
