...
{
    /// <summary></summary>
    public class ALServiceManager
	{
		internal ALServiceManager(IQiSession session)
		{
			Session = session;
		}
		...
		public static ALServiceManager CreateService(IQiSession session)
		{
			var result = new ALServiceManager(session);
		...
		///</summary>
        /// <param name="session">サービスの取得元となるセッション</param>
		public static ALServiceManager CreateUninitializedService(IQiSession session)
		{
			return new ALServiceManager(session);
		}
		...
		public void InitializeService()
		{
			if (!IsInitialized)
			{
			    SourceService = Session.GetService("ALServiceManager");
			}
		}
		...
		/// <param name="arg0"></param>
		/// <returns></returns>
        public bool StartService(string arg0)
        {
            return SourceService["startService"].Call<bool>(arg0);
        }

        /// <summary></summary>
		/// <param name="arg0"></param>
		/// <returns></returns>
        public IQiFuture<bool> StartServiceAsync(string arg0)
        {
            return SourceService["startService"].CallAsync<bool>(arg0);
        }

        /// <summary></summary>
		/// <param name="arg0"></param>
		/// <returns></returns>
        public bool RestartService(string arg0)
        {
            return SourceService["restartService"].Call<bool>(arg0);
        }

        /// <summary></summary>
		/// <param name="arg0"></param>
		/// <returns></returns>
        public IQiFuture<bool> RestartServiceAsync(string arg0)
        {
            return SourceService["restartService"].CallAsync<bool>(arg0);
        }

        /// <summary></summary>
		/// <param name="arg0"></param>
		/// <returns></returns>
        public bool StopService(string arg0)
        {
            return SourceService["stopService"].Call<bool>(arg0);
        }

        /// <summary></summary>
		/// <param name="arg0"></param>
		/// <returns></returns>
        public IQiFuture<bool> StopServiceAsync(string arg0)
        {
            return SourceService["stopService"].CallAsync<bool>(arg0);
        }

        /// <summary></summary>
		/// <param name="arg0"></param>
		/// <returns></returns>
        public bool IsServiceRunning(string arg0)
        {
            return SourceService["isServiceRunning"].Call<bool>(arg0);
        }

        /// <summary></summary>
		/// <param name="arg0"></param>
		/// <returns></returns>
        public IQiFuture<bool> IsServiceRunningAsync(string arg0)
        {
            return SourceService["isServiceRunning"].CallAsync<bool>(arg0);
        }

        /// <summary></summary>
		/// <param name="arg0"></param>
		/// <returns></returns>
        public uint ServiceMemoryUsage(string arg0)
        {
            return SourceService["serviceMemoryUsage"].Call<uint>(arg0);
        }

        /// <summary></summary>
		/// <param name="arg0"></param>
		/// <returns></returns>
        public IQiFuture<uint> ServiceMemoryUsageAsync(string arg0)
        {
            return SourceService["serviceMemoryUsage"].CallAsync<uint>(arg0);
        }
