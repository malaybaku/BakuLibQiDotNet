...
namespace Baku.LibqiDotNet.Service
{
    ...
    public class ALServiceManager
    {
        ...
        public ALServiceManager(QiSession session)
        {
        ...
        {
            return (bool)SourceService["startService"].Call(arg0);
        }
        ...
        {
            return (bool)SourceService["restartService"].Call(arg0);
        }
        ...
        {
            return (bool)SourceService["stopService"].Call(arg0);
        }
        ...
        {
            return (bool)SourceService["isServiceRunning"].Call(arg0);
        }
        ...
        {
            return (uint)SourceService["serviceMemoryUsage"].Call(arg0);
        }
