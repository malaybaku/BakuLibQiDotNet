...
namespace Baku.LibqiDotNet.Service
{
	...
	{
		internal ALAutonomousBlinking(IQiSession session)
		{
			Session = session;
		}
		...
		public static ALAutonomousBlinking CreateService(IQiSession session)
		{
			var result = new ALAutonomousBlinking(session);
		...
		///</summary>
        /// <param name="session">サービスの取得元となるセッション</param>
		public static ALAutonomousBlinking CreateUninitializedService(IQiSession session)
		{
			return new ALAutonomousBlinking(session);
		}
