...
{
    /// <summary></summary>
    public class ALSpeakingMovement
	{
		internal ALSpeakingMovement(IQiSession session)
		{
			Session = session;
		}
		...
		public static ALSpeakingMovement CreateService(IQiSession session)
		{
			var result = new ALSpeakingMovement(session);
		...
		///</summary>
        /// <param name="session">サービスの取得元となるセッション</param>
		public static ALSpeakingMovement CreateUninitializedService(IQiSession session)
		{
			return new ALSpeakingMovement(session);
		}
		...
		public void InitializeService()
		{
			if (!IsInitialized)
			{
			    SourceService = Session.GetService("ALSpeakingMovement");
			}
		}
        ...
        {
            SourceService["setMode"].Call(arg0);
        }

        /// <summary></summary>
		/// <param name="arg0"></param>
		/// <returns></returns>
        public IQiFuture SetModeAsync(string arg0)
        {
            return SourceService["setMode"].CallAsync(arg0);
        }
		...
		/// <param name="arg0"></param>
		/// <returns></returns>
        public void AddTagsToWords(object arg0)
        {
            SourceService["addTagsToWords"].Call(arg0);
        }

        /// <summary></summary>
		/// <param name="arg0"></param>
		/// <returns></returns>
        public IQiFuture AddTagsToWordsAsync(object arg0)
        {
            return SourceService["addTagsToWords"].CallAsync(arg0);
        }

        /// <summary></summary>
		/// <returns></returns>
        public void ResetTagsToWords()
        {
            SourceService["resetTagsToWords"].Call();
        }

        /// <summary></summary>
		/// <returns></returns>
        public IQiFuture ResetTagsToWordsAsync()
        {
            return SourceService["resetTagsToWords"].CallAsync();
        }
        ...
        /// <summary></summary>
		/// <returns></returns>
        public IQiResult _getConfig()
        {
            return SourceService["_getConfig"].Call<IQiResult>();
        }

        /// <summary></summary>
		/// <returns></returns>
        public IQiFuture<IQiResult> _getConfigAsync()
        {
            return SourceService["_getConfig"].CallAsync<IQiResult>();
        }
