...
{
    /// <summary></summary>
    public class ALBackgroundMovement
	{
		internal ALBackgroundMovement(IQiSession session)
		{
			Session = session;
		}
		...
		public static ALBackgroundMovement CreateService(IQiSession session)
		{
			var result = new ALBackgroundMovement(session);
		...
		///</summary>
        /// <param name="session">サービスの取得元となるセッション</param>
		public static ALBackgroundMovement CreateUninitializedService(IQiSession session)
		{
			return new ALBackgroundMovement(session);
		}
		...
		public void InitializeService()
		{
			if (!IsInitialized)
			{
			    SourceService = Session.GetService("ALBackgroundMovement");
			}
		}
		...
		/// <param name="arg0"></param>
		/// <returns></returns>
        public void _setMode(string arg0)
        {
            SourceService["_setMode"].Call(arg0);
        }

        /// <summary></summary>
		/// <param name="arg0"></param>
		/// <returns></returns>
        public IQiFuture _setModeAsync(string arg0)
        {
            return SourceService["_setMode"].CallAsync(arg0);
        }

        /// <summary></summary>
		/// <returns></returns>
        public string _getMode()
        {
            return SourceService["_getMode"].Call<string>();
        }

        /// <summary></summary>
		/// <returns></returns>
        public IQiFuture<string> _getModeAsync()
        {
            return SourceService["_getMode"].CallAsync<string>();
        }
