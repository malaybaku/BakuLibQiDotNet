...
namespace Baku.LibqiDotNet.Service
{
    ...
    public class ALBodyTemperature
	{
		internal ALBodyTemperature(IQiSession session)
		{
			Session = session;
		}
		...
		public static ALBodyTemperature CreateService(IQiSession session)
		{
			var result = new ALBodyTemperature(session);
		...
		///</summary>
        /// <param name="session">サービスの取得元となるセッション</param>
		public static ALBodyTemperature CreateUninitializedService(IQiSession session)
		{
			return new ALBodyTemperature(session);
		}
		...
		public void InitializeService()
		{
			if (!IsInitialized)
			{
			    SourceService = Session.GetService("ALBodyTemperature");
			}
		}
        ...
        public IQiResult GetTemperatureDiagnosis()
        {
            return SourceService["getTemperatureDiagnosis"].Call<IQiResult>();
        }

        /// <summary>The actual state of the temperature diagnosis.</summary>
		/// <returns>Return the current temperature diagnosis.</returns>
        public IQiFuture<IQiResult> GetTemperatureDiagnosisAsync()
        {
            return SourceService["getTemperatureDiagnosis"].CallAsync<IQiResult>();
        }
        ...
        public int _getDeviceTemperature(string arg0_deviceName)
        {
            return SourceService["_getDeviceTemperature"].Call<int>(arg0_deviceName);
        }

        /// <summary>Return the current temperature of deviceName.</summary>
		/// <param name="arg0_deviceName">A joint, actuator or sensor name.</param>
		/// <returns>Return the current temperature in degree celsius.</returns>
        public IQiFuture<int> _getDeviceTemperatureAsync(string arg0_deviceName)
        {
            return SourceService["_getDeviceTemperature"].CallAsync<int>(arg0_deviceName);
        }

        /// <summary>Return the current temperature status of deviceName.</summary>
		/// <param name="arg0_deviceName">A joint, actuator or sensor name.</param>
		/// <returns>Return the current temperature status.</returns>
        public int _getDeviceStatus(string arg0_deviceName)
        {
            return SourceService["_getDeviceStatus"].Call<int>(arg0_deviceName);
        }

        /// <summary>Return the current temperature status of deviceName.</summary>
		/// <param name="arg0_deviceName">A joint, actuator or sensor name.</param>
		/// <returns>Return the current temperature status.</returns>
        public IQiFuture<int> _getDeviceStatusAsync(string arg0_deviceName)
        {
            return SourceService["_getDeviceStatus"].CallAsync<int>(arg0_deviceName);
        }

        /// <summary>The actual state of the temperature status.</summary>
		/// <returns>Return the current temperature status.</returns>
        public IQiResult _getTemperatureStatus()
        {
            return SourceService["_getTemperatureStatus"].Call<IQiResult>();
        }

        /// <summary>The actual state of the temperature status.</summary>
		/// <returns>Return the current temperature status.</returns>
        public IQiFuture<IQiResult> _getTemperatureStatusAsync()
        {
            return SourceService["_getTemperatureStatus"].CallAsync<IQiResult>();
        }

        /// <summary>Enabled or disables file dump at temperature error.</summary>
		/// <param name="arg0_status">Enables or disables dump.</param>
		/// <returns></returns>
        public void _setEnableDump(bool arg0_status)
        {
            SourceService["_setEnableDump"].Call(arg0_status);
        }

        /// <summary>Enabled or disables file dump at temperature error.</summary>
		/// <param name="arg0_status">Enables or disables dump.</param>
		/// <returns></returns>
        public IQiFuture _setEnableDumpAsync(bool arg0_status)
        {
            return SourceService["_setEnableDump"].CallAsync(arg0_status);
        }

        /// <summary>Return true if dump to file is active.</summary>
		/// <returns>Return true if dump is enable.</returns>
        public bool _isDumpEnabled()
        {
            return SourceService["_isDumpEnabled"].Call<bool>();
        }

        /// <summary>Return true if dump to file is active.</summary>
		/// <returns>Return true if dump is enable.</returns>
        public IQiFuture<bool> _isDumpEnabledAsync()
        {
            return SourceService["_isDumpEnabled"].CallAsync<bool>();
        }
