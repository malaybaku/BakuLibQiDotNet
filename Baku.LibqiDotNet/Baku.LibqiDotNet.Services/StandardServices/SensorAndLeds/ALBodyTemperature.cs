...
namespace Baku.LibqiDotNet.Service
{
    ...
    public class ALBodyTemperature
    {
        ...
        public ALBodyTemperature(QiSession session)
        {
        ...
        public QiValue GetTemperatureDiagnosis()
        {
            return SourceService["getTemperatureDiagnosis"].Call();
        }
        ...
        {
            return (int)SourceService["_getDeviceTemperature"].Call(arg0_deviceName);
        }
        ...
        {
            return (int)SourceService["_getDeviceStatus"].Call(arg0_deviceName);
        }

        /// <summary>The actual state of the temperature status.</summary>
		/// <returns>Return the current temperature status.</returns>
        public QiValue _getTemperatureStatus()
        {
            return SourceService["_getTemperatureStatus"].Call();
        }
        ...
        {
            return (bool)SourceService["_isDumpEnabled"].Call();
        }
