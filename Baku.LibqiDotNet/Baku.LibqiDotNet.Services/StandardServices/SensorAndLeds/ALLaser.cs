...
namespace Baku.LibqiDotNet.Service
{
	...
	{
		internal ALLaser(IQiSession session)
		{
			Session = session;
		}
		...
		public static ALLaser CreateService(IQiSession session)
		{
			var result = new ALLaser(session);
		...
		///</summary>
        /// <param name="session">サービスの取得元となるセッション</param>
		public static ALLaser CreateUninitializedService(IQiSession session)
		{
			return new ALLaser(session);
		}
		...
		public void InitializeService()
		{
			if (!IsInitialized)
			{
			    SourceService = Session.GetService("ALLaser");
			}
		}
        ...
        {
            SourceService["laserOFF"].Call();
        }

        /// <summary>Disable laser light</summary>
		/// <returns></returns>
        public IQiFuture LaserOFFAsync()
        {
            return SourceService["laserOFF"].CallAsync();
        }
        ...
        public void LaserON()
        {
            SourceService["laserON"].Call();
        }

        /// <summary>Enable laser light and sampling</summary>
		/// <returns></returns>
        public IQiFuture LaserONAsync()
        {
            return SourceService["laserON"].CallAsync();
        }
		...
		/// <returns></returns>
        public void SetOpeningAngle(float arg0_angle_min_f, float arg1_angle_max_f)
        {
            SourceService["setOpeningAngle"].Call(arg0_angle_min_f, arg1_angle_max_f);
        }
		...
		/// <param name="arg1_angle_max_f">float containing the max value in rad, this value must be lower than 2.092349795 </param>
		/// <returns></returns>
        public IQiFuture SetOpeningAngleAsync(float arg0_angle_min_f, float arg1_angle_max_f)
        {
            return SourceService["setOpeningAngle"].CallAsync(arg0_angle_min_f, arg1_angle_max_f);
        }
		...
		/// <returns></returns>
        public void SetDetectingLength(int arg0_length_min_l, int arg1_length_max_l)
        {
            SourceService["setDetectingLength"].Call(arg0_length_min_l, arg1_length_max_l);
        }
		...
		/// <param name="arg1_length_max_l">int containing the max length that the laser will detect(mm), this value must be lower than 5600 mm</param>
		/// <returns></returns>
        public IQiFuture SetDetectingLengthAsync(int arg0_length_min_l, int arg1_length_max_l)
        {
            return SourceService["setDetectingLength"].CallAsync(arg0_length_min_l, arg1_length_max_l);
        }
