...
namespace Baku.LibqiDotNet.Service
{
	...
	{
		internal ALBattery(IQiSession session)
		{
			Session = session;
		}
		...
		public static ALBattery CreateService(IQiSession session)
		{
			var result = new ALBattery(session);
		...
		///</summary>
        /// <param name="session">サービスの取得元となるセッション</param>
		public static ALBattery CreateUninitializedService(IQiSession session)
		{
			return new ALBattery(session);
		}
		...
		/// <param name="arg0_Enable">True activate power monitoring</param>
		/// <returns></returns>
        public IQiFuture EnablePowerMonitoringAsync(bool arg0_Enable)
        {
            return SourceService["enablePowerMonitoring"].CallAsync(arg0_Enable);
        }
        ...
        {
            return SourceService["getBatteryCharge"].Call<int>();
        }

        /// <summary>Get the battery charge in percents</summary>
		/// <returns>the percentage of remaining power</returns>
        public IQiFuture<int> GetBatteryChargeAsync()
        {
            return SourceService["getBatteryCharge"].CallAsync<int>();
        }
		...
		/// <param name="arg0_Percent">Percentage of battery.</param>
		/// <returns></returns>
        public IQiFuture _setFirstWarningPercentAsync(int arg0_Percent)
        {
            return SourceService["_setFirstWarningPercent"].CallAsync(arg0_Percent);
        }
		...
		/// <param name="arg0_Percent">Percentage of battery.</param>
		/// <returns></returns>
        public IQiFuture _setWarningPercentAsync(int arg0_Percent)
        {
            return SourceService["_setWarningPercent"].CallAsync(arg0_Percent);
        }
		...
		/// <param name="arg0_Percent">Percentage of battery.</param>
		/// <returns></returns>
        public IQiFuture _setLastWarningPercentAsync(int arg0_Percent)
        {
            return SourceService["_setLastWarningPercent"].CallAsync(arg0_Percent);
        }
        ...
        {
            return SourceService["_hasBattery"].Call<bool>();
        }

        /// <summary>Is battery detected.</summary>
		/// <returns>Return true if battery is detected.</returns>
        public IQiFuture<bool> _hasBatteryAsync()
        {
            return SourceService["_hasBattery"].CallAsync<bool>();
        }
        ...
        {
            return SourceService["_getBatteryMode"].Call<int>();
        }

        /// <summary>Get current battery mode.</summary>
		/// <returns>Return the current battery mode. (Local = 0, robot = 1, simulation = 2)</returns>
        public IQiFuture<int> _getBatteryModeAsync()
        {
            return SourceService["_getBatteryMode"].CallAsync<int>();
        }
        ...
        {
            return SourceService["_getFullyChargedThreshold"].Call<int>();
        }

        /// <summary>Get current battery fully charged threshold.</summary>
		/// <returns>the percentage of threshold for fully charged event.</returns>
        public IQiFuture<int> _getFullyChargedThresholdAsync()
        {
            return SourceService["_getFullyChargedThreshold"].CallAsync<int>();
        }
		...
		/// <param name="arg0_threshold">the percentage of threshold for fully charged event.</param>
		/// <returns></returns>
        public IQiFuture _setFullyChargedThresholdAsync(int arg0_threshold)
        {
            return SourceService["_setFullyChargedThreshold"].CallAsync(arg0_threshold);
        }
		...
		/// <param name="arg0_status">Enables or disables mode slave.</param>
		/// <returns></returns>
        public IQiFuture _setModeSlaveAsync(bool arg0_status)
        {
            return SourceService["_setModeSlave"].CallAsync(arg0_status);
        }
