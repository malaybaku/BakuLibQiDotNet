...
namespace Baku.LibqiDotNet.Service
{
	...
	{
		internal ALTouch(IQiSession session)
		{
			Session = session;
		}
		...
		public static ALTouch CreateService(IQiSession session)
		{
			var result = new ALTouch(session);
		...
		///</summary>
        /// <param name="session">サービスの取得元となるセッション</param>
		public static ALTouch CreateUninitializedService(IQiSession session)
		{
			return new ALTouch(session);
		}
		...
		/// <returns></returns>
        public void _setTouchConfig(object arg0_config)
        {
		...
		/// <param name="arg0_config">Internal: An array of ALValues [i][0]: name, [i][1]: value</param>
		/// <returns></returns>
        public IQiFuture _setTouchConfigAsync(object arg0_config)
        {
            return SourceService["_setTouchConfig"].CallAsync(arg0_config);
        }
        ...
        {
            return SourceService["getSensorList"].Call<string[]>();
        }

        /// <summary>Return the list of sensors managed by touch module and return by TouchChangedevent.</summary>
		/// <returns>A vector&lt;std::string&gt; of sensor names manage by ALTouch.</returns>
        public IQiFuture<string[]> GetSensorListAsync()
        {
            return SourceService["getSensorList"].CallAsync<string[]>();
        }
        ...
        public IQiResult GetStatus()
        {
            return SourceService["getStatus"].Call<IQiResult>();
        }

        /// <summary>Return the current status of all Touch groups.</summary>
		/// <returns>A vector of pair [name, bool], similar to TouchChanged event.</returns>
        public IQiFuture<IQiResult> GetStatusAsync()
        {
            return SourceService["getStatus"].CallAsync<IQiResult>();
        }
        ...
        {
            return SourceService["_createGroup"].Call<bool>(arg0_groupName, arg1_jointNames);
        }
		...
		/// <param name="arg1_jointNames">A vector of joint and actuator names constituting the group.</param>
		/// <returns>true if the group was created, false otherwise.</returns>
        public IQiFuture<bool> _createGroupAsync(string arg0_groupName, IEnumerable<string> arg1_jointNames)
        {
            return SourceService["_createGroup"].CallAsync<bool>(arg0_groupName, arg1_jointNames);
        }
        ...
        {
            return SourceService["_deleteGroup"].Call<bool>(arg0_groupName);
        }

        /// <summary>Internal Use.</summary>
		/// <param name="arg0_groupName">The name of the group to delete</param>
		/// <returns>true if the group was deleted, false otherwise</returns>
        public IQiFuture<bool> _deleteGroupAsync(string arg0_groupName)
        {
            return SourceService["_deleteGroup"].CallAsync<bool>(arg0_groupName);
        }
        ...
        {
            return SourceService["_getGroupList"].Call<string[]>();
        }

        /// <summary>Internal Use.</summary>
		/// <returns>The list of groups used for sending touch events</returns>
        public IQiFuture<string[]> _getGroupListAsync()
        {
            return SourceService["_getGroupList"].CallAsync<string[]>();
        }
        ...
        {
            return SourceService["_getDetectionTypeName"].Call<string>(arg0_type);
        }

        /// <summary>Internal Use.</summary>
		/// <param name="arg0_type">Touch detection type enum</param>
		/// <returns>The name of a touch detection type</returns>
        public IQiFuture<string> _getDetectionTypeNameAsync(int arg0_type)
        {
            return SourceService["_getDetectionTypeName"].CallAsync<string>(arg0_type);
        }
		...
		/// <param name="arg0_groupName">The name of the touched group</param>
		/// <returns></returns>
        public IQiFuture _triggerMotionReflexAsync(string arg0_groupName)
        {
            return SourceService["_triggerMotionReflex"].CallAsync(arg0_groupName);
        }
		...
		/// <param name="arg0_groupName">The name of the touched group</param>
		/// <returns></returns>
        public IQiFuture _notifyTouchStoppedAsync(string arg0_groupName)
        {
            return SourceService["_notifyTouchStopped"].CallAsync(arg0_groupName);
        }
		...
		/// <param name="arg2"></param>
		/// <returns></returns>
        public void _robotFallingCallback(string arg0, object arg1, object arg2)
        {
		...
		/// <param name="arg2"></param>
		/// <returns></returns>
        public IQiFuture _robotFallingCallbackAsync(string arg0, object arg1, object arg2)
        {
            return SourceService["_robotFallingCallback"].CallAsync(arg0, arg1, arg2);
        }
		...
		/// <param name="arg2"></param>
		/// <returns></returns>
        public void _robotFallenCallback(string arg0, object arg1, object arg2)
        {
		...
		/// <param name="arg2"></param>
		/// <returns></returns>
        public IQiFuture _robotFallenCallbackAsync(string arg0, object arg1, object arg2)
        {
            return SourceService["_robotFallenCallback"].CallAsync(arg0, arg1, arg2);
        }
		...
		/// <param name="arg2"></param>
		/// <returns></returns>
        public void _diagnosisCallback(string arg0, object arg1, object arg2)
        {
		...
		/// <param name="arg2"></param>
		/// <returns></returns>
        public IQiFuture _diagnosisCallbackAsync(string arg0, object arg1, object arg2)
        {
            return SourceService["_diagnosisCallback"].CallAsync(arg0, arg1, arg2);
        }
		...
		/// <param name="arg2"></param>
		/// <returns></returns>
        public void _temperatureCallback(string arg0, object arg1, object arg2)
        {
		...
		/// <param name="arg2"></param>
		/// <returns></returns>
        public IQiFuture _temperatureCallbackAsync(string arg0, object arg1, object arg2)
        {
            return SourceService["_temperatureCallback"].CallAsync(arg0, arg1, arg2);
        }
