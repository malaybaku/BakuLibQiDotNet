...
namespace Baku.LibqiDotNet.Service
{
    ...
    public class ALFaceCharacteristics
	{
		internal ALFaceCharacteristics(IQiSession session)
		{
			Session = session;
		}
		...
		public static ALFaceCharacteristics CreateService(IQiSession session)
		{
			var result = new ALFaceCharacteristics(session);
		...
		///</summary>
        /// <param name="session">サービスの取得元となるセッション</param>
		public static ALFaceCharacteristics CreateUninitializedService(IQiSession session)
		{
			return new ALFaceCharacteristics(session);
		}
		...
		public void InitializeService()
		{
			if (!IsInitialized)
			{
			    SourceService = Session.GetService("ALFaceCharacteristics");
			}
		}
        ...
        public bool AnalyzeFaceCharacteristics(int arg0_id)
        {
            return SourceService["analyzeFaceCharacteristics"].Call<bool>(arg0_id);
        }

        /// <summary>Runs face analysis for a given person ID.</summary>
		/// <param name="arg0_id">Person ID.</param>
		/// <returns>True if the face analysis succeeded, false otherwise.</returns>
        public IQiFuture<bool> AnalyzeFaceCharacteristicsAsync(int arg0_id)
        {
            return SourceService["analyzeFaceCharacteristics"].CallAsync<bool>(arg0_id);
        }
		...
		/// <returns></returns>
        public void SetSmilingThreshold(float arg0_threshold)
        {
            SourceService["setSmilingThreshold"].Call(arg0_threshold);
        }

        /// <summary>Sets the smile degree threshold above which an event is raised.</summary>
		/// <param name="arg0_threshold">New threshold (must be between 0.0 and 1.0.</param>
		/// <returns></returns>
        public IQiFuture SetSmilingThresholdAsync(float arg0_threshold)
        {
            return SourceService["setSmilingThreshold"].CallAsync(arg0_threshold);
        }
        ...
        public float GetSmilingThreshold()
        {
            return SourceService["getSmilingThreshold"].Call<float>();
        }

        /// <summary>Gets the smile degree threshold above which an event is raised.</summary>
		/// <returns>Threshold for Smiling event</returns>
        public IQiFuture<float> GetSmilingThresholdAsync()
        {
            return SourceService["getSmilingThreshold"].CallAsync<float>();
        }
