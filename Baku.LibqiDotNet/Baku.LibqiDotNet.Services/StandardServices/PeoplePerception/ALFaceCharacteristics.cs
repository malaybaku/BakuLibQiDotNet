...
namespace Baku.LibqiDotNet.Service
{
    ...
    public class ALFaceCharacteristics
    {
        ...
        public ALFaceCharacteristics(QiSession session)
        {
        ...
        {
            return (bool)SourceService["analyzeFaceCharacteristics"].Call(arg0_id);
        }
        ...
        {
            return (float)SourceService["getSmilingThreshold"].Call();
        }
