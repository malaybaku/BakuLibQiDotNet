...
namespace Baku.LibqiDotNet.Service
{
    ...
    public class ALEngagementZones
    {
        ...
        public ALEngagementZones(QiSession session)
        {
        ...
        {
            return (float)SourceService["getLimitAngle"].Call();
        }
        ...
        {
            return (float)SourceService["getFirstLimitDistance"].Call();
        }
        ...
        {
            return (float)SourceService["getSecondLimitDistance"].Call();
        }
        ...
        {
            return (int)SourceService["computeEngagementZone"].Call(arg0_x, arg1_y, arg2_z);
        }
		...
		/// <returns>Engagement zone of the object</returns>
        public int ComputeEngagementZone(float arg0_xAngle, float arg1_yAngle, float arg2_distance, QiAnyValue arg3_cameraPositionRobot)
        {
            return (int)SourceService["computeEngagementZone"].Call(arg0_xAngle, arg1_yAngle, arg2_distance, arg3_cameraPositionRobot);
        }
