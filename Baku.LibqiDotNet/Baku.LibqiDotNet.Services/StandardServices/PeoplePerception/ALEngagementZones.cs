...
namespace Baku.LibqiDotNet.Service
{
    ...
    public class ALEngagementZones
	{
		internal ALEngagementZones(IQiSession session)
		{
			Session = session;
		}
		...
		public static ALEngagementZones CreateService(IQiSession session)
		{
			var result = new ALEngagementZones(session);
		...
		///</summary>
        /// <param name="session">サービスの取得元となるセッション</param>
		public static ALEngagementZones CreateUninitializedService(IQiSession session)
		{
			return new ALEngagementZones(session);
		}
		...
		public void InitializeService()
		{
			if (!IsInitialized)
			{
			    SourceService = Session.GetService("ALEngagementZones");
			}
		}
		...
		/// <returns></returns>
        public void SetLimitAngle(float arg0_angle)
        {
            SourceService["setLimitAngle"].Call(arg0_angle);
        }

        /// <summary>Set the angle used for the delimitation of the engagement zones</summary>
		/// <param name="arg0_angle">New angle (in degrees) for delimitation, it should be below 180</param>
		/// <returns></returns>
        public IQiFuture SetLimitAngleAsync(float arg0_angle)
        {
            return SourceService["setLimitAngle"].CallAsync(arg0_angle);
        }
        ...
        {
            return SourceService["getLimitAngle"].Call<float>();
        }

        /// <summary>Get the angle used for the delimitation of the engagement zones</summary>
		/// <returns>Current angle used for delimitation</returns>
        public IQiFuture<float> GetLimitAngleAsync()
        {
            return SourceService["getLimitAngle"].CallAsync<float>();
        }
		...
		/// <returns></returns>
        public void SetFirstLimitDistance(float arg0_distance)
        {
            SourceService["setFirstLimitDistance"].Call(arg0_distance);
        }

        /// <summary>Set the first distance used for the delimitation of the engagement zones (nearest limit)</summary>
		/// <param name="arg0_distance">New first distance (in meters) for delimitation (nearest limit), it should be positive and smaller than the second distance</param>
		/// <returns></returns>
        public IQiFuture SetFirstLimitDistanceAsync(float arg0_distance)
        {
            return SourceService["setFirstLimitDistance"].CallAsync(arg0_distance);
        }
        ...
        public float GetFirstLimitDistance()
        {
            return SourceService["getFirstLimitDistance"].Call<float>();
        }

        /// <summary>Get the first distance used for the delimitation of the engagement zones (nearest limit)</summary>
		/// <returns>Current first distance (in meters) used for delimitation (nearest limit)</returns>
        public IQiFuture<float> GetFirstLimitDistanceAsync()
        {
            return SourceService["getFirstLimitDistance"].CallAsync<float>();
        }
		...
		/// <returns></returns>
        public void SetSecondLimitDistance(float arg0_distance)
        {
            SourceService["setSecondLimitDistance"].Call(arg0_distance);
        }

        /// <summary>Set the second distance used for the delimitation of the engagement zones (furthest limit)</summary>
		/// <param name="arg0_distance">New second distance (in meters) for delimitation (furthest limit), it should be positive and bigger than the first distance</param>
		/// <returns></returns>
        public IQiFuture SetSecondLimitDistanceAsync(float arg0_distance)
        {
            return SourceService["setSecondLimitDistance"].CallAsync(arg0_distance);
        }
        ...
        public float GetSecondLimitDistance()
        {
            return SourceService["getSecondLimitDistance"].Call<float>();
        }

        /// <summary>Get the second distance used for the delimitation of the engagement zones (furthest limit)</summary>
		/// <returns>Current second distance (in meters) used for delimitation (furthest limit)</returns>
        public IQiFuture<float> GetSecondLimitDistanceAsync()
        {
            return SourceService["getSecondLimitDistance"].CallAsync<float>();
        }
        ...
        public int ComputeEngagementZone(float arg0_x, float arg1_y, float arg2_z)
        {
            return SourceService["computeEngagementZone"].Call<int>(arg0_x, arg1_y, arg2_z);
        }
		...
		/// <param name="arg2_z">Z coordinate of the object in FRAME_ROBOT</param>
		/// <returns>Engagement zone of the object</returns>
        public IQiFuture<int> ComputeEngagementZoneAsync(float arg0_x, float arg1_y, float arg2_z)
        {
            return SourceService["computeEngagementZone"].CallAsync<int>(arg0_x, arg1_y, arg2_z);
        }
		...
		/// <returns>Engagement zone of the object</returns>
        public int ComputeEngagementZone(float arg0_xAngle, float arg1_yAngle, float arg2_distance, object arg3_cameraPositionRobot)
        {
            return SourceService["computeEngagementZone"].Call<int>(arg0_xAngle, arg1_yAngle, arg2_distance, arg3_cameraPositionRobot);
        }
		...
		/// <param name="arg3_cameraPositionRobot">camera position in FRAME_ROBOT</param>
		/// <returns>Engagement zone of the object</returns>
        public IQiFuture<int> ComputeEngagementZoneAsync(float arg0_xAngle, float arg1_yAngle, float arg2_distance, object arg3_cameraPositionRobot)
        {
            return SourceService["computeEngagementZone"].CallAsync<int>(arg0_xAngle, arg1_yAngle, arg2_distance, arg3_cameraPositionRobot);
        }
