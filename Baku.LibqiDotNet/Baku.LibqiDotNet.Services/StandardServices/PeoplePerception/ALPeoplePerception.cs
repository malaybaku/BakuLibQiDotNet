...
namespace Baku.LibqiDotNet.Service
{
	...
	{
		internal ALPeoplePerception(IQiSession session)
		{
			Session = session;
		}
		...
		public static ALPeoplePerception CreateService(IQiSession session)
		{
			var result = new ALPeoplePerception(session);
		...
		///</summary>
        /// <param name="session">サービスの取得元となるセッション</param>
		public static ALPeoplePerception CreateUninitializedService(IQiSession session)
		{
			return new ALPeoplePerception(session);
		}
        ...
        {
            return SourceService["getMaximumDetectionRange"].Call<float>();
        }

        /// <summary>Gets the current maximum detection and tracking range.</summary>
		/// <returns>Maximum range in meters.</returns>
        public IQiFuture<float> GetMaximumDetectionRangeAsync()
        {
            return SourceService["getMaximumDetectionRange"].CallAsync<float>();
        }
        ...
        {
            return SourceService["getMinimumBodyHeight"].Call<float>();
        }

        /// <summary>Gets the current minimum body height used for human detection (3D mode only).</summary>
		/// <returns>Minimum height in meters.</returns>
        public IQiFuture<float> GetMinimumBodyHeightAsync()
        {
            return SourceService["getMinimumBodyHeight"].CallAsync<float>();
        }
        ...
        {
            return SourceService["getMaximumBodyHeight"].Call<float>();
        }

        /// <summary>Gets the current maximum body height used for human detection (3D mode only).</summary>
		/// <returns>Maximum height in meters.</returns>
        public IQiFuture<float> GetMaximumBodyHeightAsync()
        {
            return SourceService["getMaximumBodyHeight"].CallAsync<float>();
        }
        ...
        {
            return SourceService["getTimeBeforePersonDisappears"].Call<float>();
        }

        /// <summary>Gets the time after which a person, supposed not to be in the field of view of the camera disappears if it has not been detected.</summary>
		/// <returns>Time in seconds.</returns>
        public IQiFuture<float> GetTimeBeforePersonDisappearsAsync()
        {
            return SourceService["getTimeBeforePersonDisappears"].CallAsync<float>();
        }
        ...
        {
            return SourceService["getTimeBeforeVisiblePersonDisappears"].Call<float>();
        }

        /// <summary>Gets the time after which a person, supposed to be in the field of view of the camera disappears if it has not been detected.</summary>
		/// <returns>Time in seconds.</returns>
        public IQiFuture<float> GetTimeBeforeVisiblePersonDisappearsAsync()
        {
            return SourceService["getTimeBeforeVisiblePersonDisappears"].CallAsync<float>();
        }
        ...
        {
            return SourceService["isFaceDetectionEnabled"].Call<bool>();
        }

        /// <summary>Gets the current status of face detection.</summary>
		/// <returns>True if face detection is enabled, False otherwise.</returns>
        public IQiFuture<bool> IsFaceDetectionEnabledAsync()
        {
            return SourceService["isFaceDetectionEnabled"].CallAsync<bool>();
        }
        ...
        {
            return SourceService["isFastModeEnabled"].Call<bool>();
        }

        /// <summary>Gets the current status of fast mode.</summary>
		/// <returns>True if fast mode is enabled, False otherwise.</returns>
        public IQiFuture<bool> IsFastModeEnabledAsync()
        {
            return SourceService["isFastModeEnabled"].CallAsync<bool>();
        }
        ...
        {
            return SourceService["isGraphicalDisplayEnabled"].Call<bool>();
        }

        /// <summary>Gets the current status of graphical display in Choregraphe.</summary>
		/// <returns>True if graphical display is enabled, False otherwise.</returns>
        public IQiFuture<bool> IsGraphicalDisplayEnabledAsync()
        {
            return SourceService["isGraphicalDisplayEnabled"].CallAsync<bool>();
        }
        ...
        {
            return SourceService["isMovementDetectionEnabled"].Call<bool>();
        }

        /// <summary>Gets the current status of movement detection in Choregraphe.</summary>
		/// <returns>True if movement detection is enabled, False otherwise.</returns>
        public IQiFuture<bool> IsMovementDetectionEnabledAsync()
        {
            return SourceService["isMovementDetectionEnabled"].CallAsync<bool>();
        }
        ...
        /// <summary>Empties the tracked population.</summary>
		/// <returns></returns>
        public IQiFuture ResetPopulationAsync()
        {
            return SourceService["resetPopulation"].CallAsync();
        }
		...
		/// <param name="arg0_enable">True to turn it on, False to turn it off.</param>
		/// <returns></returns>
        public IQiFuture SetFastModeEnabledAsync(bool arg0_enable)
        {
            return SourceService["setFastModeEnabled"].CallAsync(arg0_enable);
        }
		...
		/// <param name="arg0_enable">True to turn it on, False to turn it off.</param>
		/// <returns></returns>
        public IQiFuture SetGraphicalDisplayEnabledAsync(bool arg0_enable)
        {
            return SourceService["setGraphicalDisplayEnabled"].CallAsync(arg0_enable);
        }
		...
		/// <param name="arg0_range">Maximum range in meters.</param>
		/// <returns></returns>
        public IQiFuture SetMaximumDetectionRangeAsync(float arg0_range)
        {
            return SourceService["setMaximumDetectionRange"].CallAsync(arg0_range);
        }
		...
		/// <param name="arg0_height">Minimum height in meters.</param>
		/// <returns></returns>
        public IQiFuture SetMinimumBodyHeightAsync(float arg0_height)
        {
            return SourceService["setMinimumBodyHeight"].CallAsync(arg0_height);
        }
		...
		/// <param name="arg0_height">Maximum height in meters.</param>
		/// <returns></returns>
        public IQiFuture SetMaximumBodyHeightAsync(float arg0_height)
        {
            return SourceService["setMaximumBodyHeight"].CallAsync(arg0_height);
        }
		...
		/// <param name="arg0_enable">True to turn it on, False to turn it off.</param>
		/// <returns></returns>
        public IQiFuture SetMovementDetectionEnabledAsync(bool arg0_enable)
        {
            return SourceService["setMovementDetectionEnabled"].CallAsync(arg0_enable);
        }
		...
		/// <param name="arg0_seconds">Time in seconds.</param>
		/// <returns></returns>
        public IQiFuture SetTimeBeforePersonDisappearsAsync(float arg0_seconds)
        {
            return SourceService["setTimeBeforePersonDisappears"].CallAsync(arg0_seconds);
        }
		...
		/// <param name="arg0_seconds">Time in seconds.</param>
		/// <returns></returns>
        public IQiFuture SetTimeBeforeVisiblePersonDisappearsAsync(float arg0_seconds)
        {
            return SourceService["setTimeBeforeVisiblePersonDisappears"].CallAsync(arg0_seconds);
        }
		...
		/// <param name="arg0_enable">True to turn it on, False to turn it off.</param>
		/// <returns></returns>
        public IQiFuture SetFaceDetectionEnabledAsync(bool arg0_enable)
        {
            return SourceService["setFaceDetectionEnabled"].CallAsync(arg0_enable);
        }
