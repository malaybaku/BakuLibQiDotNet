...
namespace Baku.LibqiDotNet.Service
{
	...
	{
		internal ALFaceDetection(IQiSession session)
		{
			Session = session;
		}
		...
		public static ALFaceDetection CreateService(IQiSession session)
		{
			var result = new ALFaceDetection(session);
		...
		///</summary>
        /// <param name="session">サービスの取得元となるセッション</param>
		public static ALFaceDetection CreateUninitializedService(IQiSession session)
		{
			return new ALFaceDetection(session);
		}
		...
		/// <param name="arg0_enable">True/False</param>
		/// <returns></returns>
        public IQiFuture EnableRecognitionAsync(bool arg0_enable)
        {
            return SourceService["enableRecognition"].CallAsync(arg0_enable);
        }
		...
		/// <param name="arg0_enable">True/False</param>
		/// <returns></returns>
        public IQiFuture SetRecognitionEnabledAsync(bool arg0_enable)
        {
            return SourceService["setRecognitionEnabled"].CallAsync(arg0_enable);
        }
        ...
        {
            return SourceService["isRecognitionEnabled"].Call<bool>();
        }

        /// <summary>Returns if recognition is enabled.</summary>
		/// <returns>True/False</returns>
        public IQiFuture<bool> IsRecognitionEnabledAsync()
        {
            return SourceService["isRecognitionEnabled"].CallAsync<bool>();
        }
        ...
        {
            return SourceService["getRecognitionConfidenceThreshold"].Call<float>();
        }

        /// <summary>Get the current confidence threshold for face recognition.</summary>
		/// <returns>Confidence threshold</returns>
        public IQiFuture<float> GetRecognitionConfidenceThresholdAsync()
        {
            return SourceService["getRecognitionConfidenceThreshold"].CallAsync<float>();
        }
		...
		/// <param name="arg0_confThreshold">New confidence threshold between 0.0 and 1.0 (default 0.4).</param>
		/// <returns></returns>
        public IQiFuture SetRecognitionConfidenceThresholdAsync(float arg0_confThreshold)
        {
            return SourceService["setRecognitionConfidenceThreshold"].CallAsync(arg0_confThreshold);
        }
		...
		/// <param name="arg0_enable">True/False</param>
		/// <returns></returns>
        public IQiFuture EnableTrackingAsync(bool arg0_enable)
        {
            return SourceService["enableTracking"].CallAsync(arg0_enable);
        }
		...
		/// <param name="arg0_enable">True/False</param>
		/// <returns></returns>
        public IQiFuture SetTrackingEnabledAsync(bool arg0_enable)
        {
            return SourceService["setTrackingEnabled"].CallAsync(arg0_enable);
        }
        ...
        {
            return SourceService["isTrackingEnabled"].Call<bool>();
        }

        /// <summary>(BETA) Returns if tracking is enabled.</summary>
		/// <returns>True/False</returns>
        public IQiFuture<bool> IsTrackingEnabledAsync()
        {
            return SourceService["isTrackingEnabled"].CallAsync<bool>();
        }
        ...
        {
            return SourceService["learnFace"].Call<bool>(arg0_pId);
        }

        /// <summary>Add a new face in the database.</summary>
		/// <param name="arg0_pId">The name of the person to save</param>
		/// <returns>true if the operation succeeds</returns>
        public IQiFuture<bool> LearnFaceAsync(string arg0_pId)
        {
            return SourceService["learnFace"].CallAsync<bool>(arg0_pId);
        }
        ...
        {
            return SourceService["reLearnFace"].Call<bool>(arg0_pId);
        }

        /// <summary>use in a new learning process the latest images where a face has been wrongly recognized </summary>
		/// <param name="arg0_pId">The name of the person to save</param>
		/// <returns>true if the operation succeeds</returns>
        public IQiFuture<bool> ReLearnFaceAsync(string arg0_pId)
        {
            return SourceService["reLearnFace"].CallAsync<bool>(arg0_pId);
        }
        ...
        {
            return SourceService["forgetPerson"].Call<bool>(arg0_pId);
        }

        /// <summary>Delete from the database all faces instances of a person.</summary>
		/// <param name="arg0_pId">The name of the person to forget</param>
		/// <returns>true if the operation succeeds</returns>
        public IQiFuture<bool> ForgetPersonAsync(string arg0_pId)
        {
            return SourceService["forgetPerson"].CallAsync<bool>(arg0_pId);
        }
        ...
        {
            return SourceService["clearDatabase"].Call<bool>();
        }

        /// <summary>Remove all faces from the database.</summary>
		/// <returns>true if the operation succeeds</returns>
        public IQiFuture<bool> ClearDatabaseAsync()
        {
            return SourceService["clearDatabase"].CallAsync<bool>();
        }
        ...
        {
            return SourceService["_setDetectionMode"].Call<bool>(arg0_mode);
        }

        /// <summary>Changes the mode of detection</summary>
		/// <param name="arg0_mode">0 - Still Image,Motion mode:1 - Whole search mode,2 - 3 Partition search mode,3 - Gradual progress search mode.</param>
		/// <returns>True if success</returns>
        public IQiFuture<bool> _setDetectionModeAsync(int arg0_mode)
        {
            return SourceService["_setDetectionMode"].CallAsync<bool>(arg0_mode);
        }
        ...
        {
            return SourceService["_getDetectionMode"].Call<int>();
        }

        /// <summary>Returns the current mode of detection</summary>
		/// <returns>current mode of detection (0, 1, 2 or 3)</returns>
        public IQiFuture<int> _getDetectionModeAsync()
        {
            return SourceService["_getDetectionMode"].CallAsync<int>();
        }
        ...
        {
            return SourceService["_isFaceAnalysisEnabled"].Call<bool>();
        }

        /// <summary>Returns the current face analysis state</summary>
		/// <returns>True/False</returns>
        public IQiFuture<bool> _isFaceAnalysisEnabledAsync()
        {
            return SourceService["_isFaceAnalysisEnabled"].CallAsync<bool>();
        }
		...
		/// <param name="arg0_enabled">True to enable, False to disable</param>
		/// <returns></returns>
        public IQiFuture _setFaceAnalysisEnabledAsync(bool arg0_enabled)
        {
            return SourceService["_setFaceAnalysisEnabled"].CallAsync(arg0_enabled);
        }
        ...
        {
            return SourceService["importOldDatabase"].Call<bool>(arg0_policy);
        }

        /// <summary>Imports the content of an old face reco DB</summary>
		/// <param name="arg0_policy">Merging policy if an imported entry has the same name as an existing one.It can be either:&quot;overwrite&quot; to replace the existing entry by the imported one,&quot;merge&quot; to merge data from both entries (if they don't relate to the same person, face recognition may fail),&quot;keep&quot; to keep the existing entry and skip the imported one.</param>
		/// <returns>True if the import succeeded, false otherwise.</returns>
        public IQiFuture<bool> ImportOldDatabaseAsync(string arg0_policy)
        {
            return SourceService["importOldDatabase"].CallAsync<bool>(arg0_policy);
        }

        /// <summary>Returns the list of learned faces.</summary>
		/// <returns>List of names</returns>
        public IQiResult GetLearnedFacesList()
        {
            return SourceService["getLearnedFacesList"].Call<IQiResult>();
        }

        /// <summary>Returns the list of learned faces.</summary>
		/// <returns>List of names</returns>
        public IQiFuture<IQiResult> GetLearnedFacesListAsync()
        {
            return SourceService["getLearnedFacesList"].CallAsync<IQiResult>();
        }
