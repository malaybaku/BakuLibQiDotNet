...
namespace Baku.LibqiDotNet.Service
{
    ...
    public class ALSoundLocalization
	{
		internal ALSoundLocalization(IQiSession session)
		{
			Session = session;
		}
		...
		public static ALSoundLocalization CreateService(IQiSession session)
		{
			var result = new ALSoundLocalization(session);
		...
		///</summary>
        /// <param name="session">サービスの取得元となるセッション</param>
		public static ALSoundLocalization CreateUninitializedService(IQiSession session)
		{
			return new ALSoundLocalization(session);
		}
		...
		public void InitializeService()
		{
			if (!IsInitialized)
			{
			    SourceService = Session.GetService("ALSoundLocalization");
			}
		}
