...
namespace Baku.LibqiDotNet.Service
{
    ...
    public class ALVoiceEmotionAnalysis
	{
		internal ALVoiceEmotionAnalysis(IQiSession session)
		{
			Session = session;
		}
		...
		public static ALVoiceEmotionAnalysis CreateService(IQiSession session)
		{
			var result = new ALVoiceEmotionAnalysis(session);
		...
		///</summary>
        /// <param name="session">サービスの取得元となるセッション</param>
		public static ALVoiceEmotionAnalysis CreateUninitializedService(IQiSession session)
		{
			return new ALVoiceEmotionAnalysis(session);
		}
		...
		public void InitializeService()
		{
			if (!IsInitialized)
			{
			    SourceService = Session.GetService("ALVoiceEmotionAnalysis");
			}
		}
		...
		/// <returns></returns>
        public void _onSpeechDetected(string arg0_key, object arg1_value)
        {
            SourceService["_onSpeechDetected"].Call(arg0_key, arg1_value);
        }
		...
		/// <param name="arg1_value">ALValue of key.</param>
		/// <returns></returns>
        public IQiFuture _onSpeechDetectedAsync(string arg0_key, object arg1_value)
        {
            return SourceService["_onSpeechDetected"].CallAsync(arg0_key, arg1_value);
        }
		...
		/// <returns></returns>
        public void SetParameter(string arg0_parameter, object arg1_value)
        {
            SourceService["setParameter"].Call(arg0_parameter, arg1_value);
        }
		...
		/// <param name="arg1_value">&quot;MinSignalLength&quot; : int &gt; 0.</param>
		/// <returns></returns>
        public IQiFuture SetParameterAsync(string arg0_parameter, object arg1_value)
        {
            return SourceService["setParameter"].CallAsync(arg0_parameter, arg1_value);
        }
