...
namespace Baku.LibqiDotNet.Service
{
    ...
    public class ALVoiceEmotionAnalysis
    {
        ...
        public ALVoiceEmotionAnalysis(QiSession session)
        {
		...
		/// <returns></returns>
        public void _onSpeechDetected(string arg0_key, QiAnyValue arg1_value)
        {
		...
		/// <returns></returns>
        public void SetParameter(string arg0_parameter, QiAnyValue arg1_value)
        {
