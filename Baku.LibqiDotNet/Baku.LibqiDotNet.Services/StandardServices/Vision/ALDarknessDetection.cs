...
namespace Baku.LibqiDotNet.Service
{
    ...
    public class ALDarknessDetection
	{
		internal ALDarknessDetection(IQiSession session)
		{
			Session = session;
		}
		...
		public static ALDarknessDetection CreateService(IQiSession session)
		{
			var result = new ALDarknessDetection(session);
		...
		///</summary>
        /// <param name="session">サービスの取得元となるセッション</param>
		public static ALDarknessDetection CreateUninitializedService(IQiSession session)
		{
			return new ALDarknessDetection(session);
		}
		...
		public void InitializeService()
		{
			if (!IsInitialized)
			{
			    SourceService = Session.GetService("ALDarknessDetection");
			}
		}
		...
		/// <returns></returns>
        public void SetDarknessThreshold(int arg0_threshold)
        {
            SourceService["setDarknessThreshold"].Call(arg0_threshold);
        }

        /// <summary>Enables to change the DarknessThreshold for isItDark</summary>
		/// <param name="arg0_threshold">New darkness threshold (between 0 and 100)</param>
		/// <returns></returns>
        public IQiFuture SetDarknessThresholdAsync(int arg0_threshold)
        {
            return SourceService["setDarknessThreshold"].CallAsync(arg0_threshold);
        }
        ...
        {
            return SourceService["getDarknessThreshold"].Call<int>();
        }

        /// <summary>Returns the current DarknessThreshold for isItDark</summary>
		/// <returns>Current darkness threshold value</returns>
        public IQiFuture<int> GetDarknessThresholdAsync()
        {
            return SourceService["getDarknessThreshold"].CallAsync<int>();
        }
