...
namespace Baku.LibqiDotNet.Service
{
    ...
    public class ALColorBlobDetection
    {
        ...
        public ALColorBlobDetection(QiSession session)
        {
        ...
        public QiValue GetCircle()
        {
            return SourceService["getCircle"].Call();
        }
        ...
        {
            return (bool)SourceService["getAutoExposure"].Call();
        }
