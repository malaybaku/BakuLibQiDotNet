...
namespace Baku.LibqiDotNet.Service
{
    ...
    public class ALColorBlobDetection
	{
		internal ALColorBlobDetection(IQiSession session)
		{
			Session = session;
		}
		...
		public static ALColorBlobDetection CreateService(IQiSession session)
		{
			var result = new ALColorBlobDetection(session);
		...
		///</summary>
        /// <param name="session">サービスの取得元となるセッション</param>
		public static ALColorBlobDetection CreateUninitializedService(IQiSession session)
		{
			return new ALColorBlobDetection(session);
		}
		...
		public void InitializeService()
		{
			if (!IsInitialized)
			{
			    SourceService = Session.GetService("ALColorBlobDetection");
			}
		}
		...
		/// <returns></returns>
        public void SetColor(int arg0_r, int arg1_g, int arg2_b, int arg3_colorThres)
        {
            SourceService["setColor"].Call(arg0_r, arg1_g, arg2_b, arg3_colorThres);
        }
		...
		/// <param name="arg3_colorThres">The color threshold</param>
		/// <returns></returns>
        public IQiFuture SetColorAsync(int arg0_r, int arg1_g, int arg2_b, int arg3_colorThres)
        {
            return SourceService["setColor"].CallAsync(arg0_r, arg1_g, arg2_b, arg3_colorThres);
        }
		...
		/// <returns></returns>
        public void SetObjectProperties(int arg0_minSize, float arg1_span)
        {
            SourceService["setObjectProperties"].Call(arg0_minSize, arg1_span);
        }
		...
		/// <param name="arg1_span">The span of the object in meters</param>
		/// <returns></returns>
        public IQiFuture SetObjectPropertiesAsync(int arg0_minSize, float arg1_span)
        {
            return SourceService["setObjectProperties"].CallAsync(arg0_minSize, arg1_span);
        }
		...
		/// <returns></returns>
        public void SetObjectProperties(int arg0_minSize, float arg1_span, string arg2_shape)
        {
            SourceService["setObjectProperties"].Call(arg0_minSize, arg1_span, arg2_shape);
        }
		...
		/// <param name="arg2_shape">The shape of the object</param>
		/// <returns></returns>
        public IQiFuture SetObjectPropertiesAsync(int arg0_minSize, float arg1_span, string arg2_shape)
        {
            return SourceService["setObjectProperties"].CallAsync(arg0_minSize, arg1_span, arg2_shape);
        }
        ...
        public IQiResult GetCircle()
        {
            return SourceService["getCircle"].Call<IQiResult>();
        }

        /// <summary>Send back the x,y,radius of the circle if any</summary>
		/// <returns>The circle as x,y,radius in image relative coordinates (x,radius divided by rows and y by cols)</returns>
        public IQiFuture<IQiResult> GetCircleAsync()
        {
            return SourceService["getCircle"].CallAsync<IQiResult>();
        }
        ...
        {
            return SourceService["getAutoExposure"].Call<bool>();
        }

        /// <summary>Get the camera auto exposure mode</summary>
		/// <returns>A flag saying the exposure is auto or not</returns>
        public IQiFuture<bool> GetAutoExposureAsync()
        {
            return SourceService["getAutoExposure"].CallAsync<bool>();
        }

        /// <summary>Set the camera auto exposure to on</summary>
		/// <param name="arg0_mode">Whether the exposure is auto or not</param>
		/// <returns></returns>
        public void SetAutoExposure(bool arg0_mode)
        {
            SourceService["setAutoExposure"].Call(arg0_mode);
        }

        /// <summary>Set the camera auto exposure to on</summary>
		/// <param name="arg0_mode">Whether the exposure is auto or not</param>
		/// <returns></returns>
        public IQiFuture SetAutoExposureAsync(bool arg0_mode)
        {
            return SourceService["setAutoExposure"].CallAsync(arg0_mode);
        }
