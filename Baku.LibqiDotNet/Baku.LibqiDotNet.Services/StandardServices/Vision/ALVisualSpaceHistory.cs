...
namespace Baku.LibqiDotNet.Service
{
    ...
    public class ALVisualSpaceHistory
	{
		internal ALVisualSpaceHistory(IQiSession session)
		{
			Session = session;
		}
		...
		public static ALVisualSpaceHistory CreateService(IQiSession session)
		{
			var result = new ALVisualSpaceHistory(session);
		...
		///</summary>
        /// <param name="session">サービスの取得元となるセッション</param>
		public static ALVisualSpaceHistory CreateUninitializedService(IQiSession session)
		{
			return new ALVisualSpaceHistory(session);
		}
		...
		public void InitializeService()
		{
			if (!IsInitialized)
			{
			    SourceService = Session.GetService("ALVisualSpaceHistory");
			}
		}
		...
		/// <returns></returns>
        public void SetGridPrecision(float arg0_precision)
        {
            SourceService["setGridPrecision"].Call(arg0_precision);
        }

        /// <summary>Sets grid precision</summary>
		/// <param name="arg0_precision">float, ratio between camera field of view and grid cell field of view in each dimension. Setting the grid precision will reset the grid.</param>
		/// <returns></returns>
        public IQiFuture SetGridPrecisionAsync(float arg0_precision)
        {
            return SourceService["setGridPrecision"].CallAsync(arg0_precision);
        }

        /// <summary>Gets grid precision</summary>
		/// <returns>Grid precision</returns>
        public float GetGridPrecision()
        {
            return SourceService["getGridPrecision"].Call<float>();
        }

        /// <summary>Gets grid precision</summary>
		/// <returns>Grid precision</returns>
        public IQiFuture<float> GetGridPrecisionAsync()
        {
            return SourceService["getGridPrecision"].CallAsync<float>();
        }
        ...
        {
            SourceService["resetGrid"].Call();
        }

        /// <summary>Resets grid with current timestamp</summary>
		/// <returns></returns>
        public IQiFuture ResetGridAsync()
        {
            return SourceService["resetGrid"].CallAsync();
        }
