...
namespace Baku.LibqiDotNet.Libqi
{
    ...
    public sealed class QiBool : QiInputValue
    {
        /// <summary>
    ...
    public sealed class QiInt8 : QiInputValue
    {
        /// <summary>
        /// 格納する値を指定してインスタンスを初期化します。
        /// </summary>
    ...
    public sealed class QiInt16 : QiInputValue
    {
        /// <summary>
        /// 格納する値を指定してインスタンスを初期化します。
        /// </summary>
    ...
    public sealed class QiInt32 : QiInputValue
    {
        /// <summary>
        /// 格納する値を指定してインスタンスを初期化します。
        /// </summary>
    ...
    public sealed class QiInt64 : QiInputValue
    {
        /// <summary>
        /// 格納する値を指定してインスタンスを初期化します。
        /// </summary>
    ...
    public sealed class QiUInt8 : QiInputValue
    {
        /// <summary>
        /// 格納する値を指定してインスタンスを初期化します。
        /// </summary>
    ...
    public sealed class QiUInt16 : QiInputValue
    {
        /// <summary>
        /// 格納する値を指定してインスタンスを初期化します。
        /// </summary>
    ...
    public sealed class QiUInt32 : QiInputValue
    {
        /// <summary>
        /// 格納する値を指定してインスタンスを初期化します。
        /// </summary>
    ...
    public sealed class QiUInt64 : QiInputValue
    {
        /// <summary>
        /// 格納する値を指定してインスタンスを初期化します。
        /// </summary>
