...
namespace Baku.LibqiDotNet.Libqi
{
    ...
    public sealed class QiDynamic : QiInputValue
    {
        /// <summary>
        ...
        public QiDynamic(QiInputValue v) : this(v.QiValue) { }
    ...
    {
        /// <summary>
        /// <see cref="QiInputValue"/>の派生型変数を動的型にキャストします。
        /// </summary>
        /// <param name="v">何かしらの値</param>
        /// <returns>指定した値を動的型コンテナに格納した値</returns>
        public static QiDynamic ToDynamic(this QiInputValue v) => new QiDynamic(v);
    }
}
